...
export const SPEECH_WAIT_PAUSE_SECONDS = Number(process.env.SPEECH_WAIT_PAUSE_SECONDS || 2); // Pause between /speech-wait polls
...
// Capped at 1 use per turn (poll 1 only) to avoid becoming repetitive.
...
export function fromPluginConfig(cfg) {
  ...
  return {
    ...
    SPEECH_WAIT_PAUSE_SECONDS:  cfg.speechWaitPauseSeconds    ?? 2,
